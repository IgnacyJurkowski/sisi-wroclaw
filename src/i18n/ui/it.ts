...
const it: UI = {
  ...
  configurator: {
    ...
    space: {
      ...
      shared: 'Area comune',
      options: {
        sisi: { title: 'Club SiSi', body: 'Bar, DJ e musica dal vivo - feste e serate.' },
        cork: { title: 'Ristorante The Cork', body: 'Cena al tavolo in stile sharing - fino a 150 posti.' },
        r32: { title: 'Tutto il complesso R32', body: 'Cena al The Cork e serata al SiSi - 663 m², fino a 500 ospiti in piedi.' },
        unsure: { title: 'Non lo so ancora', body: 'Proporremo lo spazio in base ai dettagli.' },
      },
      recommend: {
        heading: 'Proponiamo',
        sisiBlocked: 'Il sabato il SiSi e tutto R32 non sono disponibili - scegli The Cork o un’altra data.',
        note: 'In base ai dettagli proponiamo: {space}.',
        proposal: 'proposta: {space}',
        reasons: {
          seated: 'cena al tavolo', standing: 'buffet e in piedi', mixed: 'cena e parte serale', afterClose: 'dopo le {close} la serata continua al SiSi',
          overSeated: 'più di {seated} posti al The Cork', overStanding: 'più di {standing} ospiti', largeGroup: 'gruppo più numeroso', daytime: 'inizio di giorno', evening: 'inizio serale',
          sisiBlocked: 'il sabato il SiSi non è disponibile',
        },
      },
    },
    details: {
      ...
      length: 'Durata',
      hoursShort: '{hours} h',
      plan: 'Programma della serata',
      planCork: '{from}–{to} The Cork',
      planSisi: '{from}–{to} SiSi',
      corkWindow: 'Quel giorno The Cork accoglie gruppi dalle {from} alle {to}.',
      corkWindowFix: 'Imposta {time}',
      extensionSave: 'Una cena fino a {hours} h rientra nel tempo incluso - senza supplemento.',
      nightFee: { friday: 'Affitto del SiSi di venerdì: +{fee}' },
      sisiBlocked: 'Il sabato il SiSi non è disponibile per l’affitto - la serata al The Cork dura fino alle {close}.',
      timeOther: 'Altro orario - da concordare',
      timeHint: 'Gli orari di inizio al The Cork dipendono dal giorno della settimana; scegli prima la data.',
      adults: 'Numero di ospiti',
      seating: {
      ...
      duration: {
        label: 'Tempo al The Cork',
        base: 'Tempo incluso per {guests} ospiti',
        hours: 'fino a {hours} ore',
        individual: 'concordato individualmente',
        extensionAuto: '+{hours} h di estensione (+{pct}% del prezzo del menu) - deriva dall’ora di fine.',
        tooLong: 'Oltre {hours} ore il tempo si concorda individualmente.',
        closing: 'The Cork chiude alle {close} - dopo, la serata continua al SiSi.',
        none: 'Nessuna estensione',
        plus1: '+1 ora',
        plus2: '+2 ore',
      },
      capacity: {
        ...
        min: 'Organizziamo eventi per gruppi da {min} persone.',
        corkExclusive: 'Da {min} ospiti è possibile l’uso esclusivo di tutto il ristorante - tempi e prezzo da concordare.',
      },
    },
    menu: {
      heading: 'Componi il menu',
      tabs: {
        corkFood: 'The Cork · Cibo', corkFoodSub: 'pacchetti sharing',
        corkDrinks: 'The Cork · Bevande', corkDrinksSub: 'vino e open bar',
        drinks: 'SiSi · Bar', drinksSub: 'cocktail, vini, bottiglie',
        food: 'SiSi · Snack', foodSub: 'Night Menu by The Cork',
      },
      corkClosing: 'The Cork chiude alle {close}. Dalle {close} alle {end} la serata continua al SiSi - abbiamo aggiunto il bar SiSi al menu.',
      cork: {
        ...
        wineTitle: 'Vino per tutta la durata',
        perAdultLabel: 'prezzo a persona',
        openBar: 'Open bar',
      ...
      decrease: 'Meno',
      increase: 'Più',
      fullMenu: 'Vedi il menu completo del SiSi',
      estimate: {
        heading: 'La tua stima',
        corkFood: 'Menu The Cork',
        corkDrinks: 'Bevande The Cork',
        drinks: 'Bar SiSi',
        food: 'Snack SiSi',
        nightFee: 'Affitto del SiSi',
        decor: 'Decorazioni',
        cake: 'Torta (da)',
    ...
    extras: {
      ...
      cake: {
        heading: 'Torta',
        with: 'Torta The Cork',
        withHint: 'classica o a piani · gusto e forma a scelta',
        without: 'Senza torta',
        withoutHint: 'salta la torta',
        size: 'Forma',
        portions: 'porzioni',
        from: 'da',
        tieredHint: 'feste più grandi e un ingresso a effetto',
        base: 'Pan di Spagna',
        flavour: 'Gusto',
        decor: 'Decorazione della torta',
        decorPlaceholder: 'Es. decorazione delicata in verde e oro, scritta “40 anni”, senza fiori freschi…',
        priceNote: 'Prezzo della torta su quotazione individuale; la decorazione incide sul prezzo finale.',
      },
      decor: {
        heading: 'Decorazioni',
        tables: 'Allestimento dei tavoli',
        photo: 'Photo wall',
        none: 'Nessuno',
        noneHint: '0 zł',
        attractions: 'Attrazioni extra',
        idea: 'La tua idea',
        ideaPlaceholder: 'Tema, colori, occasione e desideri personali…',
        perTable: 'per tavolo da 8 · per {guests} ospiti: {total}',
        quoted: 'quotazione dopo consulenza',
      },
      services: 'Allestimento dell’evento',
      items: {
    ...
    summary: {
      ...
      labels: {
        occasion: 'Tipo', date: 'Data', time: 'Orari', guests: 'Ospiti', seating: 'Formula', space: 'Spazio',
        duration: 'Tempo', corkMenu: 'Menu The Cork', corkDrinks: 'Bevande The Cork', drinks: 'Bar SiSi', food: 'Snack SiSi',
        cake: 'Torta', decor: 'Decorazioni', extras: 'Allestimento', estimate: 'Stima',
      },
      toBeAgreed: 'da concordare',
      none: 'nessuna selezione',
      guestsUnit: 'pers.',
      cork: {
        heading: 'Condizioni The Cork',
        value: 'Valore dell’offerta prima del servizio',
        service: 'Servizio 10%',
        total: 'Totale per il gruppo',
        deposit: 'Acconto 50%',
        depositHint: 'da versare 7 giorni prima dell’evento',
        balance: 'Saldo a fine evento',
        balanceHint: 'con carta o contanti, anche American Express',
    ...
    wizard: {
      ...
      hints: { occasion: 'Scegli il tipo di evento.', space: 'Scegli lo spazio.', details: 'Indica la data, l’ora di inizio, la durata e il numero di ospiti.', menu: 'Aggiungi un pacchetto o voci dal menu per vedere la stima.', summary: 'Inserisci nome ed e-mail e ti invieremo una proposta.' },
      blocked: { occasion: 'Scegli prima il tipo di evento - poi passi ai dettagli.', space: 'Scegli prima uno spazio oppure "Non lo so ancora".' },
      tips: {
        duration: 'Durata totale dell’evento dall’ora di inizio. The Cork chiude alle 22:00.', guests: 'Organizziamo eventi per gruppi da 10 persone.', hours: 'La durata del pacchetto copre il tempo al The Cork.', occasion: 'Adatto all’occasione scelta.', exclusive: 'I gruppi più numerosi possono affittare The Cork in esclusiva.', space: 'Deriva dal numero di ospiti, dalla formula e dagli orari.',
        service: 'Calcolato sul valore dell’offerta The Cork.', cake: 'Il prezzo finale dipende dalla decorazione.', nightFee: 'Costo dell’affitto del SiSi di venerdì.', decor: 'L’allestimento dei tavoli è calcolato per tavolo da 8.', chosen: 'Piatti nel pacchetto. La prima spunta seleziona il pacchetto.',
      },
    },
  },
