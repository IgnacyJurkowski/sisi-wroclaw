...
const it: UI = {
  ...
  configurator: {
    ...
    wizard: {
      ...
      hints: { occasion: 'Scegli il tipo di evento.', space: 'Scegli lo spazio.', details: 'Indica la data, gli orari e il numero di ospiti.', menu: 'Aggiungi un pacchetto o voci dal menu per vedere la stima.', summary: 'Inserisci nome ed e-mail e ti invieremo una proposta.' },
    },
  },
