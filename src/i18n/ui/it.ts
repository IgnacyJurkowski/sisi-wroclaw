...
const it: UI = {
  meta: {
    ...
    configurator: {
      title: 'Configuratore eventi - organizza la tua festa al SiSi | SiSi Breslavia',
      description:
        'Organizza un compleanno, una festa privata o un evento aziendale al SiSi, al The Cork o in tutto R32: scegli data, numero di ospiti, spazio, cocktail e snack dal menu e invia la richiesta per una proposta personalizzata.',
      ogDescription:
        'Scegli data, ospiti, spazio e voci dal menu SiSi. Invia la configurazione e il team preparerà una proposta personalizzata.',
    },
    contact: {
  ...
  nav: {
    ...
    configurator: 'Configuratore eventi',
  ...
  reservationsHome: {
    ...
    terms: 'La prenotazione di un tavolo è di 100 zł a persona, utilizzabili al tavolo; il sabato si applica un ingresso aggiuntivo di 40 zł a persona.',
    info: {
      hours: 'Orari',
      address: 'Indirizzo',
      reservations: 'Prenotazioni',
  ...
  reservationsPage: {
    ...
    practicalConditions: [
      'Il costo della prenotazione è di 100 PLN a persona - l\'intero importo è utilizzabile al tavolo con il personale.',
  ...
  configurator: {
    hero: {
      ...
      body: 'Scegli il tipo di evento, lo spazio, i cocktail e gli snack dal nostro menu. Alla fine vedrai un riepilogo e lo invierai al team, che preparerà una proposta personalizzata.',
      start: 'Iniziamo',
    },
    progress: {
      label: 'Avanzamento della configurazione',
      stepLabel: 'Passo {n}',
      steps: { details: 'Dettagli', space: 'Spazio', menu: 'Menu', extras: 'Extra', summary: 'Riepilogo' },
    },
    occasion: {
      heading: 'Scegli il tipo di evento',
      options: {
        birthday: 'Compleanno',
        anniversary: 'Anniversario',
        celebration: 'Festa privata',
        corporate: 'Festa aziendale',
        other: 'Altra occasione',
      },
    },
    details: {
      heading: 'Informazioni di base',
      intro: 'Indica la data, il numero di ospiti e la formula. Su questa base sceglieremo lo spazio.',
      time: 'Ora di inizio',
      timeHint: 'Indicativa - il programma esatto lo definiremo insieme.',
      guestsHint: 'Numero indicativo - potrai modificarlo in seguito.',
      seating: {
        label: 'Formula dell’evento',
        seated: 'Cena al tavolo',
        seatedHint: 'fino a 150 posti a sedere al The Cork',
        standing: 'Buffet in piedi',
        standingHint: 'fino a 500 ospiti in tutto R32',
        mixed: 'Cena e serata',
        mixedHint: 'cena al tavolo, poi il club',
      },
      capacity: {
        seated: 'Con {guests} ospiti una cena al tavolo supera i {capacity} posti a sedere del The Cork. Proporremo una formula a buffet o una serata divisa in due parti.',
        standing: 'Più di {capacity} ospiti superano la capienza di R32. Scrivici e verificheremo cosa è possibile.',
      },
    },
    space: {
      heading: 'Scegli lo spazio',
      intro: 'Indica lo spazio che preferisci. La disposizione finale e la disponibilità saranno confermate dal nostro team.',
      planAlt: 'Planimetria del complesso R32: club SiSi e ristorante The Cork',
      planCaption: 'Planimetria R32 - club SiSi e ristorante The Cork, Rzeźnicza 32-33',
      planHint: 'Clicca su SiSi o The Cork nella planimetria per scegliere lo spazio.',
      selected: 'Selezionato:',
      options: {
        sisi: { title: 'Club SiSi', body: 'Music club con bar, DJ e musica dal vivo - per feste e serate.' },
        cork: { title: 'Ristorante The Cork', body: 'Ristorante per una cena al tavolo - fino a 150 posti a sedere.' },
        r32: { title: 'Tutto il complesso R32', body: 'SiSi e The Cork insieme - 663 m² in totale, fino a 500 ospiti in piedi (buffet).' },
        unsure: { title: 'Non lo so ancora', body: 'Ti consiglieremo lo spazio in base al numero di ospiti e al carattere dell’evento.' },
      },
    },
    menu: {
      heading: 'Componi bar e snack',
      intro: 'Scegli le voci dal menu attuale del SiSi e indica le quantità. Gli importi seguono i prezzi del menu - un punto di partenza per la conversazione, non un’offerta.',
      ...
      units: { perGuest: 'per ospite', bottle: 'bott.', portion: 'porzioni' },
      decrease: 'Meno',
      increase: 'Più',
      fullMenu: 'Vedi il menu completo',
      estimate: {
        heading: 'La tua stima',
        drinks: 'Bevande',
        food: 'Snack',
        total: 'Totale a prezzi di menu',
        perGuest: 'per ospite',
        guests: 'ospiti',
    ...
    extras: {
      heading: 'Extra e allestimento',
      intro: 'Indica cos’altro dobbiamo includere. Questi elementi vengono quotati individualmente.',
      quoted: 'quotazione individuale',
      items: {
        exclusive: { title: 'Uso esclusivo', body: 'SiSi, The Cork o tutto il complesso R32 solo per i tuoi ospiti.' },
        music: { title: 'Musica', body: 'DJ o musica dal vivo in linea con il carattere dell’evento.' },
        screens: { title: 'Schermi per presentazioni', body: 'Due schermi per una presentazione, gli auguri o uno slideshow.' },
        catering: { title: 'Catering', body: 'Una proposta di menu per tutto il gruppo, concordata con il nostro team.' },
      },
    },
    summary: {
      heading: 'Il tuo evento a R32',
      intro: 'Controlla le scelte e lascia i tuoi contatti. Su questa base prepareremo una proposta personalizzata.',
      planCard: 'Piano dell’evento',
      labels: {
        occasion: 'Tipo',
        date: 'Data',
        time: 'Ora',
        ...
        food: 'Snack',
        extras: 'Extra',
        estimate: 'Stima a prezzi di menu',
      },
      ...
      terms: {
        ...
        body: 'Il costo viene definito individualmente dopo aver discusso i dettagli dell’evento. La data viene confermata con un contratto e un acconto; il saldo è dovuto prima dell’evento.',
      },
      form: {
        heading: 'Dove inviamo la proposta?',
        intro: 'Il riepilogo della configurazione viene allegato alla richiesta.',
        configLabel: 'Configurazione',
        messagePlaceholder: 'Scrivici cos’altro dovremmo sapere sul tuo evento.',
        success: 'Grazie! Abbiamo ricevuto la tua configurazione e ti ricontatteremo con una proposta personalizzata.',
        subject: 'Richiesta dal configuratore eventi - SiSi Wrocław',
      },
    },
    buttons: {
      toSpace: 'Scegli lo spazio',
      toMenu: 'Componi il menu',
      toExtras: 'Aggiungi extra',
      toSummary: 'Vai al riepilogo',
    },
  },
