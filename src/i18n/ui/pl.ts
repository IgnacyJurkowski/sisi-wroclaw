...
const pl = {
  ...
  configurator: {
    hero: {
      ...
      body: 'Wybierz przestrzeń, termin i menu - w klubie SiSi, restauracji The Cork albo całym R32. Na końcu zobaczysz podsumowanie i wyślesz je do zespołu, który przygotuje indywidualną propozycję.',
      start: 'Zaczynamy',
    },
    progress: {
    ...
    space: {
      ...
      options: {
        ...
        unsure: { title: 'Nie wiem jeszcze', body: 'Pokażemy obie oferty, a przestrzeń doradzimy po rozmowie.' },
      },
    },
    details: {
      ...
      adults: 'Dorośli',
      adultsHint: 'oraz osoby powyżej 15 lat',
      childrenSmall: 'Dzieci 0-5 lat',
      childrenSmallHint: 'bezpłatnie',
      children: 'Dzieci 6-15 lat',
      childrenHint: '50% ceny menu lub menu dziecięce',
      childrenNote: 'Zasady kolacji w The Cork.',
      seating: {
      ...
      duration: {
        ...
        noneHint: 'bez dopłaty',
        plus1: '+1 godzina',
        plus2: '+2 godziny',
        surcharge: '+{pct}% ceny menu',
      },
      capacity: {
        ...
        corkMin: 'Pakiety The Cork obowiązują dla grup od {min} osób - mniejsze grupy rezerwujemy jako zwykły stolik.',
    ...
    menu: {
      ...
      estimate: {
        ...
        total: 'Razem',
        perGuest: 'na dorosłego',
        guests: 'gości',
        adults: 'dorosłych',
        children: 'dzieci w cenie 50%',
