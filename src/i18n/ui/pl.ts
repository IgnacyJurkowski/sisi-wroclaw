...
const pl = {
  ...
  configurator: {
    ...
    wizard: {
      ...
      hints: { occasion: 'Wybierz rodzaj wydarzenia.', space: 'Wybierz przestrzeń.', details: 'Podaj termin, godziny i liczbę gości.', menu: 'Dodaj pakiet lub pozycje z karty, aby zobaczyć szacunek.', summary: 'Wpisz imię i e-mail, a wyślemy propozycję.' },
    },
  },
