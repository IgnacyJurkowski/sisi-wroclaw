  ...
  configurator: {
    ...
    space: {
      ...
      options: {
        ...
        unsure: { title: 'Not sure yet', body: 'We will propose a space from your details.' },
      },
      recommend: {
        heading: 'We propose',
        sisiBlocked: 'On Saturdays SiSi and the whole R32 are not available - choose The Cork or another date.',
        note: 'Based on the details we propose: {space}.',
        proposal: 'proposal: {space}',
        reasons: {
          seated: 'seated dinner', standing: 'buffet and standing', mixed: 'dinner and an evening part', afterClose: 'after {close} the evening continues at SiSi',
          overSeated: 'more than {seated} seats at The Cork', overStanding: 'more than {standing} guests', largeGroup: 'a larger group', daytime: 'daytime start', evening: 'evening start',
          sisiBlocked: 'SiSi is unavailable on Saturdays',
        },
      },
    },
    details: {
      ...
      length: 'Duration',
      hoursShort: '{hours} h',
      plan: 'Plan for the evening',
      planCork: '{from}–{to} The Cork',
      planSisi: '{from}–{to} SiSi',
      corkWindow: 'On that day The Cork takes groups from {from} to {to}.',
      corkWindowFix: 'Set {time}',
      extensionSave: 'A dinner of up to {hours} h fits the included time - no surcharge.',
      nightFee: { friday: 'SiSi hire on a Friday: +{fee}' },
      sisiBlocked: 'SiSi cannot be hired on Saturdays - the evening at The Cork runs until {close}.',
      ...
      duration: {
        ...
        extensionAuto: '+{hours} h extension (+{pct}% of the menu price) - follows from the end time.',
        tooLong: 'Beyond {hours} hours the time is agreed individually.',
        closing: 'The Cork closes at {close} - after that the evening continues at SiSi.',
        none: 'No extension',
        plus1: '+1 hour',
        plus2: '+2 hours',
      },
      capacity: {
        ...
        min: 'We plan events for groups of {min} or more.',
    ...
    menu: {
      ...
      corkClosing: 'The Cork closes at {close}. From {close} to {end} the evening continues at SiSi - we added the SiSi bar to the menu.',
      cork: {
    ...
    extras: {
      ...
      decor: {
        ...
        perTable: 'per table of 8 · for {guests} guests: {total}',
    ...
    summary: {
      ...
      planCard: 'Event plan',
      labels: {
        occasion: 'Type', date: 'Date', time: 'Hours', guests: 'Guests', seating: 'Format', space: 'Space',
