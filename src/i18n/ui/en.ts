...
const en: UI = {
  ...
  configurator: {
    ...
    details: {
      ...
      adults: 'Adults',
      adultsHint: 'and guests over 15',
      childrenSmall: 'Children 0-5',
      childrenSmallHint: 'free of charge',
      children: 'Children 6-15',
      childrenHint: '50% of the menu price or a children\'s menu',
      childrenNote: 'The Cork dinner rules.',
      seating: {
        label: 'Event format',
