...
const en: UI = {
  ...
  configurator: {
    hero: {
      ...
      body: 'Choose the type of event, the space, and cocktails and snacks from our menu. At the end you will see a summary and send it to the team, who will prepare a tailored proposal.',
      start: 'Get started',
    },
    progress: {
      label: 'Configuration progress',
      stepLabel: 'Step {n}',
      steps: { details: 'Details', space: 'Space', menu: 'Menu', extras: 'Extras', summary: 'Summary' },
    },
    occasion: {
      heading: 'Choose the type of event',
      options: {
        birthday: 'Birthday',
        anniversary: 'Anniversary',
    ...
    details: {
      ...
      intro: 'Tell us the date, the number of guests and the format. We will match the space to it.',
      time: 'Start time',
      timeHint: 'Approximate - we will agree the exact schedule together.',
      guestsHint: 'An estimate - you can change it later.',
      seating: {
        label: 'Event format',
    ...
    space: {
      ...
      options: {
        ...
        cork: { title: 'The Cork restaurant', body: 'A restaurant for a seated dinner - up to 150 seats.' },
        r32: { title: 'The entire R32', body: 'SiSi and The Cork together - 663 m² in total, up to 500 standing guests (buffet).' },
        unsure: { title: 'Not sure yet', body: 'We will recommend a space based on your guest count and the character of the event.' },
      },
    },
    menu: {
      heading: 'Build your bar and snacks',
      intro: 'Pick items from the current SiSi menu and set quantities. Amounts use menu prices - a starting point for the conversation, not an offer.',
    ...
    extras: {
      ...
      intro: 'Tick what else we should include. These elements are quoted individually.',
    ...
    summary: {
      ...
      labels: {
        ...
        food: 'Snacks',
        extras: 'Extras',
        estimate: 'Estimate at menu prices',
      },
    ...
    buttons: {
      toSpace: 'Choose a space',
      toMenu: 'Build the menu',
      toExtras: 'Add extras',
      toSummary: 'Go to the summary',
    },
  },
