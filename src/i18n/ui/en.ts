/* English. Mirrors the shape of pl.ts (enforced by `: UI`). */
import type { UI } from './pl';

const en: UI = {
  meta: {
    home: {
      title: 'Music Club & Cocktail Bar in Wrocław | SiSi',
      description:
    ...
    events: {
      ...
      description:
        'Upcoming events at SiSi Wrocław - concerts, DJs and themed nights inside the R32 complex. Browse the archive of past nights too.',
      ogDescription: 'Concerts, DJs and themed nights. Upcoming events and archive at SiSi Wrocław.',
    },
    menu: {
      title: 'Bar Menu & Cocktails | SiSi Wrocław',
      description: 'The SiSi Wrocław bar menu - signature cocktails, Polish wines, Belgian beers and a Night Menu by The Cork.',
    ...
    configurator: {
      title: 'Event Configurator - Plan Your Party at SiSi | SiSi Wrocław',
      description:
        'Plan a birthday, private party or company event at SiSi, The Cork or the entire R32: pick a date, guest count, space, cocktails and snacks from the menu, then send the enquiry for a tailored proposal.',
      ogDescription:
        'Pick a date, guests, space and items from the SiSi menu. Send your configuration and the team will prepare a tailored proposal.',
    },
    contact: {
      title: 'Contact & Company Details | SiSi Wrocław',
      description:
        'Contact details and company information for SiSi Wrocław - address, phone, email and registration data (NIP, REGON, KRS).',
      ogDescription: 'Contact and company details for SiSi Wrocław.',
    },
    blog: {
      title: 'Blog | SiSi Wrocław',
      description:
        'The SiSi Wrocław blog - guides to the city nightlife, ideas for the evening and notes straight from the club on Rzeźnicza.',
      ogDescription: 'Guides to Wrocław nightlife and ideas for a night out at SiSi.',
    },
    terms: {
      title: 'Terms - SiSi Wrocław',
      description: 'House rules for SiSi Wrocław - entry, table reservations, conduct on the premises and complaints.',
      ogDescription: 'House rules for SiSi Wrocław - entry, reservations, conduct and complaints.',
    },
    privacy: {
      title: 'Privacy Policy - SiSi Wrocław',
      description: 'SiSi Wrocław privacy policy - data controller, purposes and legal bases of processing and your GDPR rights.',
      ogDescription: 'How we process personal data at SiSi Wrocław - in line with the GDPR.',
    },
    cookies: {
    ...
    notFound: {
      ...
      description: 'The page you are looking for does not exist. Return to the SiSi Wrocław homepage.',
      ogDescription: 'Page not found. Return to the SiSi Wrocław homepage.',
    },
  },

  common: {
    hoursDays: 'Friday - Saturday',
  },
  ...
  footer: {
    ...
    legalHeading: 'Legal',
    rights: '© 2026 SiSi Wrocław. All rights reserved.',
  },
  ...
  reservationsHome: {
    ...
    terms: 'A table reservation is 100 zł per person, credited at your table; on Saturdays a 40 zł per-person entry applies.',
    info: {
      hours: 'Hours',
      address: 'Address',
      reservations: 'Reservations',
  ...
  eventsPage: {
    ...
    title: 'Events',
    subtitle:
      'Concerts, DJs and themed nights. Scroll to see what we are playing in the coming weekends - and dip into the archive of past nights.',
    upcoming: 'Upcoming',
    archive: 'Archive',
    scrollHint: 'scroll →',
    back: 'All events',
  ...
  blogPage: {
    label: 'From the blog',
    title: 'Blog',
    subtitle: 'Guides to Wrocław nightlife, ideas for the evening and notes straight from the club.',
  ...
  menuPage: {
    ...
    whiskyGroups: { irish: 'Irish', scotch: 'Scotch', japanese: 'Japanese', bourbon: 'Bourbon' },
  ...
  careersPage: {
    label: 'Join us',
    title: 'Careers',
    subtitle: 'We are looking for people with a passion for good drinks and music. The club runs Fridays and Saturdays - bartenders also work midweek, during The Cork hours.',
    positionLabel: 'Position',
    apply: 'Apply',
    howToApply: 'How to apply',
    howLead: 'Send your CV to {email}',
    howNote: 'Put the role and your full name in the subject line, e.g. {example}.',
    howExample: 'Bartender - Jan Kowalski',
    jobs: [
      {
        title: 'Bartender',
        bullets: [
          'Preparing cocktails and running the bar',
          'Bar experience welcome',
          'Fridays and Saturdays, with possible midweek shifts (The Cork hours)',
      ...
      },
      {
        title: 'Barback',
        bullets: [
          'Supporting the bartender and stocking the bar',
          'An ideal entry-level role in the industry',
          'Weekend work (Friday-Saturday)',
  ...
  reservationsPage: {
    ...
    practicalConditions: [
      'The reservation fee is PLN 100 per person - the full amount can be spent at your table with our staff.',
  ...
  contactPage: {
    label: 'Information',
    subtitle: 'Reservations, corporate events and registration details of the company operating the SiSi club.',
    contactHeading: 'Contact',
    reservationsLabel: 'Table reservations',
    corporateLabel: 'Corporate events',
    addressLabel: 'Address',
    hoursLabel: 'Opening hours',
    registryHeading: 'Company details',
    registryIntro: 'The SiSi club is operated, and personal data is controlled, by:',
    legalForm: 'Legal form: limited liability company (sp. z o.o.). Registry court: District Court for Wrocław-Fabryczna in Wrocław.',
  },
  ...
  configurator: {
    ...
    space: {
      ...
      shared: 'Shared area',
      options: {
        sisi: { title: 'SiSi club', body: 'Bar, DJs and live music - evening parties and celebrations.' },
        cork: { title: 'The Cork restaurant', body: 'A seated sharing-style dinner - up to 150 seats.' },
        r32: { title: 'The entire R32', body: 'Dinner at The Cork and the evening at SiSi - 663 m², up to 500 standing guests.' },
        unsure: { title: 'Not sure yet', body: 'We show both offers and recommend a space after a chat.' },
      },
    },
    details: {
      ...
      seating: {
        ...
        seatedHint: 'up to 150 seats at The Cork',
        standing: 'Buffet and standing',
        standingHint: 'up to 500 guests across R32',
        mixed: 'Dinner then party',
        mixedHint: 'seated dinner, then the club',
      },
      duration: {
        label: 'Time at The Cork',
        base: 'Included time for {guests} guests',
        hours: 'up to {hours} hours',
        individual: 'agreed individually',
        none: 'No extension',
        noneHint: 'no surcharge',
        plus1: '+1 hour',
        plus2: '+2 hours',
        surcharge: '+{pct}% on the menu price',
      },
      capacity: {
        seated: 'With {guests} guests a seated dinner exceeds the {capacity} seats at The Cork. We will suggest a buffet format or splitting the evening into two parts.',
        standing: 'More than {capacity} guests exceeds the capacity of R32. Write to us and we will check what is possible.',
        corkMin: 'The Cork packages apply to groups of {min} or more - smaller groups book an ordinary table.',
        corkExclusive: 'From {min} guests the whole restaurant can be hired exclusively - time and price agreed individually.',
      },
    },
    menu: {
      ...
      tabs: {
        ...
        drinks: 'SiSi · Bar', drinksSub: 'cocktails, wines, bottles',
      ...
      cork: {
        ...
        wineTitle: 'Wine throughout the event',
        perAdultLabel: 'price per person',
        openBar: 'Open bar',
      ...
      units: { perGuest: 'per guest', bottle: 'btl.', portion: 'portions' },
      decrease: 'Fewer',
      increase: 'More',
      fullMenu: 'See the full SiSi menu',
      estimate: {
        heading: 'Your estimate',
        corkFood: 'The Cork menu',
        corkDrinks: 'The Cork drinks',
        drinks: 'SiSi bar',
        food: 'SiSi snacks',
        decor: 'Decorations',
        cake: 'Cake (from)',
    ...
    extras: {
      ...
      cake: {
        heading: 'Cake',
        with: 'The Cork cake',
        withHint: 'classic or tiered · flavour and shape of your choice',
        without: 'No cake',
        withoutHint: 'skip the cake',
        size: 'Shape',
        portions: 'portions',
        from: 'from',
        tieredHint: 'larger parties and a grand entrance',
        base: 'Sponge',
        flavour: 'Flavour',
        decor: 'Cake decoration',
        decorPlaceholder: 'E.g. a delicate green and gold decoration, the text “40 years”, no fresh flowers…',
        priceNote: 'Cake price quoted individually; the decoration affects the final price.',
      },
      decor: {
        heading: 'Decorations',
      ...
      items: {
        exclusive: { title: 'Exclusive hire', body: 'SiSi, The Cork or the entire R32 for your guests only.' },
        music: { title: 'Music', body: 'A DJ or live music matched to the character of the event.' },
        screens: { title: 'Presentation screens', body: 'Two screens for a presentation, wishes or a slideshow.' },
        catering: { title: 'Catering', body: 'A menu proposal for the whole group, agreed with our team.' },
      },
    },
    summary: {
      ...
      labels: {
        ...
        duration: 'Time', corkMenu: 'The Cork menu', corkDrinks: 'The Cork drinks', drinks: 'SiSi bar', food: 'SiSi snacks',
        cake: 'Cake', decor: 'Decorations', extras: 'Setting', estimate: 'Estimate',
      },
      toBeAgreed: 'to be agreed',
      none: 'none selected',
      guestsUnit: 'guests',
      cork: {
        heading: 'The Cork terms',
        value: 'Offer value before service',
        service: 'Service fee 10%',
        total: 'Total for the group',
        deposit: 'Deposit 50%',
        depositHint: 'payable 7 days before the event',
        balance: 'Balance at the end of the event',
        balanceHint: 'by card or cash, American Express accepted',
        vat: 'All prices include VAT.',
      },
      terms: {
        heading: 'Booking terms',
        body: 'Pricing is agreed individually once we have discussed the details of your event. The date is confirmed with a contract and a deposit, with the remaining balance payable before the event.',
      },
      form: {
  ...
  b2b: {
    ...
    formats: {
      heading: 'Event formats',
      intro: 'One place for both the formal programme and the evening.',
      items: [
    ...
    why: {
      ...
      items: [
        ...
        { title: 'Direct contact with the team', body: 'You speak straight to the people running the event.' },
      ],
    },
    process: {
      heading: 'How it works',
      steps: [
        { title: 'Send an enquiry', body: 'Tell us the date, format and number of guests you have in mind.' },
        { title: 'Discuss the details', body: 'We agree the event format and your requirements.' },
        { title: 'Receive a proposal', body: 'We put together a tailored offer.' },
        { title: 'Confirm the date', body: 'We lock in the date and all the details.' },
        { title: 'Deliver the event', body: 'We take care of running the event.' },
      ],
    },
    projects: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: 'Can The Cork and SiSi be used in a single event?', a: 'Yes. The formal part or dinner at The Cork can flow into an evening programme at SiSi.' },
    ...
    finalCta: {
      ...
      body: 'Tell us your preferred date, the number of guests and the event format. Our team will prepare a proposal tailored to your needs.',
      cta: 'Request a date',
    },
    form: {
      legend: 'Event enquiry',
      ...
      eventTypePlaceholder: 'Choose a type',
      eventTypeOptions: {
      ...
      dateModeSingle: 'Specific date',
      dateModeRange: 'Date range',
      datePrevMonth: 'Previous month',
      dateNextMonth: 'Next month',
      dateClear: 'Clear',
      guestsDecrease: 'Decrease number of guests',
      guestsIncrease: 'Increase number of guests',
      ...
      submit: 'Send enquiry',
      sending: 'Sending…',
      errorSummary: 'Please fix the highlighted fields to send the form.',
      errors: {
      ...
      success: {
        ...
        body: 'We will get back to you with a proposal. For anything urgent, call or email us.',
      },
      error: {
        title: 'The form could not be sent.',
        body: 'Please try again shortly, or contact us directly:',
      },
    },
  },
};
