...
const en: UI = {
  ...
  configurator: {
    ...
    wizard: {
      ...
      hints: { occasion: 'Pick the type of event.', space: 'Choose the space.', details: 'Add the date, the hours and the guest count.', menu: 'Add a package or menu items to see the estimate.', summary: 'Enter your name and e-mail and we will send a proposal.' },
    },
  },
