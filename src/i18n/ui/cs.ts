  ...
  configurator: {
    ...
    details: {
      ...
      duration: {
        ...
        extensionAuto: '+{hours} h prodloužení (+{pct} % ceny menu) - vyplývá z času ukončení.',
        tooLong: 'Nad {hours} hodin čas domlouváme individuálně.',
        closing: 'The Cork zavíráme ve {close} - poté večer pokračuje v SiSi.',
      ...
      capacity: {
        ...
        min: 'Akce plánujeme pro skupiny od {min} osob.',
    ...
    menu: {
      ...
      corkClosing: 'The Cork zavíráme ve {close}. Od {close} do {end} večer pokračuje v SiSi - přidali jsme bar SiSi do menu.',
      cork: {
    ...
    summary: {
      ...
      planCard: 'Plán akce',
      labels: {
        occasion: 'Typ', date: 'Termín', time: 'Časy', guests: 'Hosté', seating: 'Formát', space: 'Prostor',
    ...
    wizard: {
      ...
      hints: { occasion: 'Vyberte typ akce.', space: 'Vyberte prostor.', details: 'Zadejte termín, časy a počet hostů.', menu: 'Přidejte balíček nebo položky z nabídky, abyste viděli odhad.', summary: 'Zadejte jméno a e-mail a pošleme vám návrh.' },
    },
  },
