...
const cs: UI = {
  ...
  configurator: {
    ...
    details: {
      ...
      adults: 'Dospělí',
      adultsHint: 'a hosté starší 15 let',
      childrenSmall: 'Děti 0-5 let',
      childrenSmallHint: 'zdarma',
      children: 'Děti 6-15 let',
      childrenHint: '50 % ceny menu nebo dětské menu',
      childrenNote: 'Pravidla večeře v The Cork.',
      seating: {
        label: 'Formát akce',
    ...
    menu: {
      ...
      cork: {
        ...
        perAdultLabel: 'cena za dospělého',
        openBar: 'Open bar',
