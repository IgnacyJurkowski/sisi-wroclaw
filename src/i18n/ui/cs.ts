...
const cs: UI = {
  ...
  configurator: {
    hero: {
      ...
      body: 'Vyberte typ akce, prostor, koktejly a občerstvení z naší nabídky. Na konci uvidíte shrnutí a odešlete ho týmu, který připraví individuální návrh.',
      start: 'Začínáme',
    },
    progress: {
      label: 'Průběh konfigurace',
      stepLabel: 'Krok {n}',
      steps: { details: 'Podrobnosti', space: 'Prostor', menu: 'Menu', extras: 'Doplňky', summary: 'Shrnutí' },
    },
    occasion: {
      heading: 'Vyberte typ akce',
      options: {
        birthday: 'Narozeniny',
        anniversary: 'Výročí',
        celebration: 'Soukromá oslava',
        corporate: 'Firemní večírek',
        other: 'Jiná příležitost',
      },
    },
    details: {
      heading: 'Základní informace',
      intro: 'Uveďte termín, počet hostů a formát setkání. Podle toho vybereme prostor.',
      time: 'Čas začátku',
      timeHint: 'Orientačně - přesný harmonogram domluvíme společně.',
      guestsHint: 'Orientační počet - později ho můžete změnit.',
      seating: {
        label: 'Formát akce',
    ...
    space: {
      ...
      options: {
        ...
        cork: { title: 'Restaurace The Cork', body: 'Restaurace pro večeři u stolů - až 150 míst k sezení.' },
        r32: { title: 'Celý komplex R32', body: 'SiSi a The Cork dohromady - celkem 663 m², až 500 hostů ve stoje (raut).' },
        unsure: { title: 'Ještě nevím', body: 'Doporučíme prostor podle počtu hostů a charakteru akce.' },
      },
    },
    menu: {
      heading: 'Sestavte bar a občerstvení',
      intro: 'Vyberte položky z aktuální nabídky SiSi a zadejte množství. Částky počítáme podle cen v nabídce - je to výchozí bod pro rozhovor, ne nabídka.',
      ...
      decrease: 'Méně',
      increase: 'Více',
      fullMenu: 'Zobrazit celou nabídku',
      estimate: {
        heading: 'Váš odhad',
        drinks: 'Nápoje',
        food: 'Občerstvení',
        total: 'Celkem podle nabídky',
        perGuest: 'na hosta',
        guests: 'hostů',
    ...
    extras: {
      ...
      intro: 'Označte, co máme ještě zohlednit. Tyto položky oceňujeme individuálně.',
    ...
    buttons: {
      toSpace: 'Vybrat prostor',
      toMenu: 'Sestavit menu',
      toExtras: 'Přidat doplňky',
      toSummary: 'Přejít na shrnutí',
    },
  },
