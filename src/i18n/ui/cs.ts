...
const cs: UI = {
  meta: {
    ...
    configurator: {
      title: 'Konfigurátor akce - naplánujte oslavu v SiSi | SiSi Vratislav',
      description:
        'Naplánujte narozeniny, soukromou oslavu nebo firemní akci v SiSi, The Cork nebo v celém R32: vyberte termín, počet hostů, prostor, koktejly a občerstvení z nabídky a odešlete poptávku na individuální návrh.',
      ogDescription:
        'Vyberte termín, hosty, prostor a položky z nabídky SiSi. Odešlete konfiguraci a tým připraví individuální návrh.',
    },
    contact: {
  ...
  nav: {
    ...
    configurator: 'Konfigurátor akce',
  ...
  reservationsHome: {
    ...
    terms: 'Rezervace stolu je 100 zł za osobu k útratě u stolu; v sobotu se účtuje vstupné navíc 40 zł za osobu.',
    info: {
  ...
  menuPage: {
    ...
    sections: {
      ...
      cognac: 'Koňak',
      liqueurs: 'Likéry',
      vermouth: 'Vermuty a aperitivy',
      champagne: 'Šampaňské a sekt',
    ...
    whiskyGroups: { irish: 'Irská', scotch: 'Skotská', japanese: 'Japonská', bourbon: 'Bourbon' },
  ...
  reservationsPage: {
    ...
    practicalConditions: [
      'Cena rezervace je 100 PLN na osobu - celou částku lze utratit u stolu u obsluhy.',
  ...
  configurator: {
    ...
    space: {
      ...
      options: {
        sisi: { title: 'Klub SiSi', body: 'Bar, DJ a živá hudba - večerní oslavy a párty.' },
        cork: { title: 'Restaurace The Cork', body: 'Večeře u stolů ve stylu sharing - až 150 míst.' },
        r32: { title: 'Celý komplex R32', body: 'Večeře v The Cork a večer v SiSi - 663 m², až 500 hostů ve stoje.' },
        unsure: { title: 'Ještě nevím', body: 'Ukážeme obě nabídky a prostor doporučíme po rozhovoru.' },
      },
    },
    details: {
      ...
      seating: {
        label: 'Formát akce',
        seated: 'Večeře u stolů',
        seatedHint: 'až 150 míst k sezení v The Cork',
        standing: 'Raut a stání',
        standingHint: 'až 500 hostů v celém R32',
        mixed: 'Večeře a večerní program',
        mixedHint: 'večeře u stolů, poté klub',
      },
      duration: {
        label: 'Čas v The Cork',
        base: 'Zahrnutý čas pro {guests} hostů',
        hours: 'až {hours} hodin',
        individual: 'stanoven individuálně',
        none: 'Bez prodloužení',
        noneHint: 'bez příplatku',
        plus1: '+1 hodina',
        plus2: '+2 hodiny',
        surcharge: '+{pct} % k ceně menu',
      },
      capacity: {
        seated: 'Při {guests} hostech přesahuje večeře u stolů {capacity} míst k sezení v The Cork. Navrhneme rautový formát nebo rozdělení večera na dvě části.',
        standing: 'Více než {capacity} hostů přesahuje kapacitu R32. Napište nám a ověříme, co je možné.',
        corkMin: 'Balíčky The Cork platí pro skupiny od {min} osob - menší skupiny rezervují běžný stůl.',
        corkExclusive: 'Od {min} hostů je možný pronájem celé restaurace - čas a cena k domluvě.',
      },
    },
    menu: {
      ...
      tabs: {
        ...
        drinks: 'SiSi · Bar', drinksSub: 'koktejly, vína, lahve',
      ...
      cork: {
        ...
        wineTitle: 'Víno po celou dobu akce',
        perAdultLabel: 'cena za osobu',
        openBar: 'Open bar',
      ...
      units: { perGuest: 'na hosta', bottle: 'lah.', portion: 'porcí' },
      decrease: 'Méně',
      increase: 'Více',
      fullMenu: 'Zobrazit celou nabídku SiSi',
      estimate: {
        heading: 'Váš odhad',
        corkFood: 'Menu The Cork',
        corkDrinks: 'Nápoje The Cork',
        drinks: 'Bar SiSi',
    ...
    extras: {
      ...
      cake: {
        heading: 'Dort',
        with: 'Dort The Cork',
        withHint: 'klasický nebo patrový · chuť a tvar podle výběru',
        without: 'Bez dortu',
        withoutHint: 'dort přeskočit',
        size: 'Tvar',
        portions: 'porcí',
        from: 'od',
        tieredHint: 'větší oslavy a efektní nástup',
        base: 'Piškot',
        flavour: 'Chuť',
        decor: 'Dekorace dortu',
        decorPlaceholder: 'Např. jemná dekorace v zelené a zlaté, nápis „40 let“, bez živých květin…',
        priceNote: 'Cena dortu podle individuálního ocenění; dekorace ovlivňuje konečnou cenu.',
      },
      decor: {
        heading: 'Dekorace',
        tables: 'Výzdoba stolů',
        photo: 'Fotostěna',
        none: 'Bez výzdoby',
        noneHint: '0 zł',
        attractions: 'Další atrakce',
        idea: 'Váš nápad',
      ...
      items: {
        exclusive: { title: 'Pronájem na výhradní užívání', body: 'SiSi, The Cork nebo celý komplex R32 jen pro vaše hosty.' },
        music: { title: 'Hudební program', body: 'DJ nebo živá hudba podle charakteru akce.' },
        screens: { title: 'Prezentační obrazovky', body: 'Dvě obrazovky na prezentaci, přání nebo promítání.' },
        catering: { title: 'Catering', body: 'Návrh menu pro celou skupinu, domluvený s naším týmem.' },
      },
    },
    summary: {
      ...
      labels: {
        ...
        duration: 'Doba', corkMenu: 'Menu The Cork', corkDrinks: 'Nápoje The Cork', drinks: 'Bar SiSi', food: 'Občerstvení SiSi',
        cake: 'Dort', decor: 'Dekorace', extras: 'Program', estimate: 'Odhad',
      },
      toBeAgreed: 'k domluvě',
      none: 'nic nevybráno',
      guestsUnit: 'os.',
      cork: {
        heading: 'Podmínky The Cork',
        value: 'Hodnota nabídky před servisem',
        service: 'Servisní poplatek 10 %',
        total: 'Celkem pro skupinu',
        deposit: 'Záloha 50 %',
        depositHint: 'splatná 7 dní před akcí',
        balance: 'Doplatek na konci akce',
        balanceHint: 'kartou nebo hotově, i American Express',
        vat: 'Všechny ceny zahrnují DPH.',
      },
      terms: {
        heading: 'Podmínky rezervace',
        body: 'Cenu stanovujeme individuálně po projednání podrobností akce. Termín potvrzujeme smlouvou a zálohou, zbývající část je splatná před akcí.',
      },
      form: {
  ...
  b2b: {
    ...
    form: {
      ...
      dateModeSingle: 'Konkrétní datum',
      dateModeRange: 'Rozmezí dat',
      datePrevMonth: 'Předchozí měsíc',
      dateNextMonth: 'Následující měsíc',
      dateClear: 'Vymazat',
      guestsDecrease: 'Snížit počet hostů',
      guestsIncrease: 'Zvýšit počet hostů',
