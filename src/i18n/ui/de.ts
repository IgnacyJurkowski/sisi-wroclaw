...
const de: UI = {
  ...
  configurator: {
    ...
    space: {
      ...
      options: {
        sisi: { title: 'Club SiSi', body: 'Bar, DJs und Live-Musik - Abendfeiern und Partys.' },
        cork: { title: 'Restaurant The Cork', body: 'Dinner am Tisch im Sharing-Stil - bis zu 150 Plätze.' },
        r32: { title: 'Der gesamte R32', body: 'Dinner im The Cork und Abend im SiSi - 663 m², bis zu 500 Gäste stehend.' },
        unsure: { title: 'Noch unentschieden', body: 'Wir zeigen beide Angebote und empfehlen den Raum im Gespräch.' },
      },
    },
    details: {
      ...
      duration: {
        label: 'Zeit im The Cork',
        base: 'Inklusive Zeit für {guests} Gäste',
        hours: 'bis zu {hours} Stunden',
        individual: 'individuell vereinbart',
        none: 'Keine Verlängerung',
        noneHint: 'ohne Aufpreis',
        plus1: '+1 Stunde',
        plus2: '+2 Stunden',
        surcharge: '+{pct} % auf den Menüpreis',
      },
      capacity: {
        ...
        corkMin: 'Die Pakete von The Cork gelten für Gruppen ab {min} Personen - kleinere Gruppen reservieren einen normalen Tisch.',
        corkExclusive: 'Ab {min} Gästen kann das ganze Restaurant exklusiv gemietet werden - Zeit und Preis nach Absprache.',
      },
    },
    menu: {
      ...
      tabs: {
        ...
        drinks: 'SiSi · Bar', drinksSub: 'Cocktails, Weine, Flaschen',
      ...
      cork: {
        ...
        wineTitle: 'Wein während der ganzen Feier',
        perAdultLabel: 'Preis pro Person',
        openBar: 'Open Bar',
      ...
      decrease: 'Weniger',
      increase: 'Mehr',
      fullMenu: 'Zur vollständigen SiSi-Karte',
      estimate: {
        heading: 'Deine Schätzung',
        corkFood: 'Menü The Cork',
        corkDrinks: 'Getränke The Cork',
        drinks: 'Bar SiSi',
        food: 'Snacks SiSi',
        decor: 'Dekoration',
        cake: 'Torte (ab)',
    ...
    extras: {
      ...
      cake: {
        heading: 'Torte',
        with: 'Torte von The Cork',
        withHint: 'klassisch oder mehrstöckig · Geschmack und Form nach Wahl',
        without: 'Keine Torte',
        withoutHint: 'Torte überspringen',
        size: 'Form',
        portions: 'Portionen',
        from: 'ab',
        tieredHint: 'größere Feiern und ein großer Auftritt',
        base: 'Biskuit',
        flavour: 'Geschmack',
        decor: 'Tortendekoration',
        decorPlaceholder: 'Z. B. dezente Dekoration in Grün und Gold, Schriftzug „40 Jahre“, keine frischen Blumen…',
        priceNote: 'Tortenpreis nach individueller Kalkulation; die Dekoration beeinflusst den Endpreis.',
      },
      decor: {
        heading: 'Dekoration',
        tables: 'Tischdekoration',
        photo: 'Fotowand',
        none: 'Ohne',
        noneHint: '0 zł',
        attractions: 'Zusätzliche Attraktionen',
        idea: 'Deine Idee',
    ...
    summary: {
      ...
      labels: {
        ...
        duration: 'Zeit', corkMenu: 'Menü The Cork', corkDrinks: 'Getränke The Cork', drinks: 'Bar SiSi', food: 'Snacks SiSi',
        cake: 'Torte', decor: 'Dekoration', extras: 'Rahmen', estimate: 'Schätzung',
      },
      toBeAgreed: 'wird abgestimmt',
      none: 'nichts ausgewählt',
      guestsUnit: 'Pers.',
      cork: {
        heading: 'Bedingungen von The Cork',
        value: 'Angebotswert vor Service',
        service: 'Servicegebühr 10 %',
        total: 'Gesamt für die Gruppe',
        deposit: 'Anzahlung 50 %',
        depositHint: 'zahlbar 7 Tage vor der Feier',
        balance: 'Restzahlung am Ende der Feier',
        balanceHint: 'per Karte oder bar, auch American Express',
        vat: 'Alle Preise enthalten die Mehrwertsteuer.',
      },
      terms: {
