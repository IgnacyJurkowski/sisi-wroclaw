...
const de: UI = {
  ...
  configurator: {
    ...
    details: {
      ...
      adults: 'Erwachsene',
      adultsHint: 'und Gäste über 15',
      childrenSmall: 'Kinder 0-5',
      childrenSmallHint: 'kostenlos',
      children: 'Kinder 6-15',
      childrenHint: '50 % des Menüpreises oder Kindermenü',
      childrenNote: 'Regeln für das Dinner im The Cork.',
      seating: {
    ...
    menu: {
      ...
      cork: {
        ...
        perAdultLabel: 'Preis pro Erwachsenem',
        openBar: 'Open Bar',
      ...
      estimate: {
        ...
        total: 'Summe',
        perGuest: 'pro Erwachsenem',
        guests: 'Gäste',
        adults: 'Erwachsene',
        children: 'Kinder zu 50 %',
