...
const de: UI = {
  ...
  configurator: {
    ...
    wizard: {
      ...
      hints: { occasion: 'Wähle die Art des Events.', space: 'Wähle den Raum.', details: 'Gib Termin, Uhrzeiten und Gästezahl an.', menu: 'Füge ein Paket oder Positionen aus der Karte hinzu, um die Schätzung zu sehen.', summary: 'Gib Name und E-Mail an, dann schicken wir ein Angebot.' },
    },
  },
