...
const de: UI = {
  meta: {
    ...
    configurator: {
      title: 'Event-Konfigurator - Feier im SiSi planen | SiSi Breslau',
      description:
        'Plane Geburtstag, private Feier oder Firmenevent im SiSi, The Cork oder im gesamten R32: Termin, Gästezahl, Raum, Cocktails und Snacks aus der Karte wählen und die Anfrage für ein individuelles Angebot senden.',
      ogDescription:
        'Termin, Gäste, Raum und Positionen aus der SiSi-Karte wählen. Konfiguration senden - das Team erstellt ein individuelles Angebot.',
    },
    contact: {
  ...
  reservationsHome: {
    ...
    terms: 'Eine Tischreservierung kostet 100 zł pro Person, am Tisch anrechenbar; samstags gilt ein zusätzlicher Eintritt von 40 zł pro Person.',
    info: {
      hours: 'Zeiten',
      address: 'Adresse',
  ...
  blogPage: {
    label: 'Aus dem Blog',
    title: 'Blog',
    subtitle: 'Guides zum Breslauer Nachtleben, Ideen für den Abend und Notizen direkt aus dem Club.',
    empty: 'Die ersten Beiträge erscheinen bald.',
  ...
  reservationsPage: {
    ...
    practicalConditions: [
      'Die Reservierungsgebühr beträgt 100 PLN pro Person - der gesamte Betrag kann am Tisch beim Service eingelöst werden.',
  ...
  configurator: {
    hero: {
      ...
      body: 'Wähle die Art des Events, den Raum sowie Cocktails und Snacks aus unserer Karte. Am Ende siehst du eine Zusammenfassung und schickst sie an das Team, das ein individuelles Angebot erstellt.',
      start: 'Los geht’s',
    },
    progress: {
      label: 'Fortschritt der Konfiguration',
      stepLabel: 'Schritt {n}',
      steps: { details: 'Details', space: 'Raum', menu: 'Menü', extras: 'Extras', summary: 'Zusammenfassung' },
    },
    occasion: {
      heading: 'Wähle die Art des Events',
      options: {
        birthday: 'Geburtstag',
        anniversary: 'Jubiläum',
        celebration: 'Private Feier',
    ...
    details: {
      ...
      intro: 'Nenne Termin, Gästezahl und Format. Darauf stimmen wir den Raum ab.',
      time: 'Beginn',
      timeHint: 'Ungefähr - den genauen Ablauf stimmen wir gemeinsam ab.',
      guestsHint: 'Ungefähre Zahl - du kannst sie später ändern.',
      seating: {
        label: 'Format der Feier',
        seated: 'Dinner am Tisch',
        seatedHint: 'bis zu 150 Sitzplätze im The Cork',
        standing: 'Buffet und Stehempfang',
        standingHint: 'bis zu 500 Gäste im gesamten R32',
        mixed: 'Dinner und Abendprogramm',
        mixedHint: 'Dinner am Tisch, danach Club',
      },
      capacity: {
        seated: 'Bei {guests} Gästen übersteigt ein Dinner am Tisch die {capacity} Sitzplätze im The Cork. Wir schlagen ein Buffet oder eine Aufteilung des Abends in zwei Teile vor.',
        standing: 'Mehr als {capacity} Gäste übersteigen die Kapazität des R32. Schreib uns, wir prüfen, was möglich ist.',
      },
    },
    space: {
      heading: 'Wähle den Raum',
      intro: 'Markiere deinen bevorzugten Raum. Die endgültige Aufteilung und Verfügbarkeit bestätigt unser Team.',
      planAlt: 'Grundriss des R32-Komplexes: Club SiSi und Restaurant The Cork',
      planCaption: 'Grundriss R32 - Club SiSi und Restaurant The Cork, Rzeźnicza 32-33',
      planHint: 'Klicke im Plan auf SiSi oder The Cork, um einen Raum zu wählen.',
      selected: 'Ausgewählt:',
      options: {
        sisi: { title: 'Club SiSi', body: 'Musikclub mit Bar, DJs und Live-Musik - für Abendfeiern und Partys.' },
        cork: { title: 'Restaurant The Cork', body: 'Restaurant für ein Dinner am Tisch - bis zu 150 Sitzplätze.' },
        r32: { title: 'Der gesamte R32', body: 'SiSi und The Cork zusammen - insgesamt 663 m², bis zu 500 Gäste stehend (Buffet).' },
        unsure: { title: 'Noch unentschieden', body: 'Wir empfehlen einen Raum anhand von Gästezahl und Charakter des Events.' },
      },
    },
    menu: {
      heading: 'Stelle Bar und Snacks zusammen',
      intro: 'Wähle Positionen aus der aktuellen SiSi-Karte und gib Mengen an. Die Beträge basieren auf Kartenpreisen - ein Ausgangspunkt für das Gespräch, kein Angebot.',
      tabs: { drinks: 'Getränke', drinksSub: 'Cocktails, Weine, Flaschen', food: 'Snacks', foodSub: 'Night Menu by The Cork' },
      groups: {
        cocktails: 'Cocktails',
        wines: 'Polnische Weine - Flasche 750 ml',
        champagne: 'Champagner - Flasche 750 ml',
        bottles: 'Bottle Service',
        food: 'Night Menu',
      },
      hints: { perGuest: 'Anzahl pro Gast', bottles: 'Anzahl Flaschen', portions: 'Anzahl Portionen' },
      units: { perGuest: 'pro Gast', bottle: 'Fl.', portion: 'Portionen' },
      decrease: 'Weniger',
      increase: 'Mehr',
      fullMenu: 'Zur vollständigen Karte',
      estimate: {
        heading: 'Deine Schätzung',
        drinks: 'Getränke',
        food: 'Snacks',
        total: 'Summe zu Kartenpreisen',
        perGuest: 'pro Gast',
        guests: 'Gäste',
        empty: 'Füge Positionen aus der Karte hinzu, um eine Schätzung zu sehen.',
        note: 'Schätzung zu aktuellen Preisen der SiSi-Karte. Die endgültigen Kosten des Events vereinbaren wir individuell - diese Zusammenfassung ist kein Angebot.',
      },
      cork: {
        heading: 'Kalkulator des Restaurants The Cork',
        intro: 'Du hast nur das Restaurant The Cork gewählt. Menü und Preise einer Feier im Restaurant legt dessen Team fest - nutze unten den Konfigurator von The Cork und schicke uns den Rest der Anfrage wie gewohnt.',
        frameTitle: 'Feier-Konfigurator des Restaurants The Cork',
        open: 'Konfigurator von The Cork in neuem Tab öffnen',
      },
    },
    extras: {
      heading: 'Extras und Rahmen',
      intro: 'Markiere, was wir zusätzlich berücksichtigen sollen. Diese Elemente kalkulieren wir individuell.',
      quoted: 'individuelle Kalkulation',
      items: {
        exclusive: { title: 'Exklusive Anmietung', body: 'SiSi, The Cork oder der gesamte R32 nur für deine Gäste.' },
        music: { title: 'Musik', body: 'DJ oder Live-Musik, passend zum Charakter des Events.' },
        screens: { title: 'Präsentationsbildschirme', body: 'Zwei Bildschirme für Präsentation, Glückwünsche oder eine Diashow.' },
        catering: { title: 'Catering', body: 'Ein Menüvorschlag für die ganze Gruppe, abgestimmt mit unserem Team.' },
      },
    },
    summary: {
      ...
      labels: {
        ...
        food: 'Snacks',
        extras: 'Extras',
        estimate: 'Schätzung zu Kartenpreisen',
      },
      toBeAgreed: 'wird abgestimmt',
      none: 'nichts ausgewählt',
      corkCalculator: 'laut Konfigurator von The Cork',
      guestsUnit: 'Pers.',
      terms: {
        heading: 'Reservierungsbedingungen',
        body: 'Die Kosten legen wir individuell fest, nachdem wir die Details des Events besprochen haben. Den Termin bestätigen wir mit Vertrag und Anzahlung; der Restbetrag ist vor dem Event fällig.',
      },
      form: {
    ...
    buttons: {
      toSpace: 'Raum wählen',
      toMenu: 'Menü zusammenstellen',
      toExtras: 'Extras hinzufügen',
